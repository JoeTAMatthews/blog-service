...
class TestUtil {
    companion object {
        fun createPost(): Post {
            return Post(UUID.randomUUID(), "test_blog", "<h1>Test Content</h1>")
        }

        fun createPostDTO(): PostDTO {
            return PostDTO("test_blog", "<h1>Test Content</h1>", mutableListOf())
        }

        fun createDraft(): Draft {
            return Draft(UUID.randomUUID(), Post(UUID.randomUUID(), "draft_blog", "<h1>Draft Content</h1>"))
        }
